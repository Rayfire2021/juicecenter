...
label_name.place(relx=0.96,rely=0.2,anchor=CENTER)
#Dropdown
...
label_quantity = Label(root, text="Enter Quantity", bg="orange2", font=("Bahnschrift Light",12))
...
label_show_amount.place(relx=0.7,rely=0.7)
#Quantity Label
label_show_quantity = Label(root, bg="orange2", font=("Bahnschrift Light",12))
label_show_quantity.place(relx=0.95,rely=0.8,anchor=CENTER)
